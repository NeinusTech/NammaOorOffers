...
import {FaStore, FaTags, FaListAlt, FaCheckCircle} from 'react-icons/fa';
      ...
      >
        ...
        <ul className="store-nav-menu">
          <li className="store-nav-item">
            <Link
              to="/storeinformation"
              className={`store-nav-link ${location.pathname.startsWith ('/storeinformation') ? 'active' : ''}`}
          ...
          <li className="store-nav-item">
            <Link
              to="/couponform"
              className={`store-nav-link ${location.pathname.startsWith ('/couponform') ? 'active' : ''}`}
              onClick={() => setSidebarOpen (false)}
            >
          ...
          <li className="store-nav-item">
            <Link
              to="/couponlist"
              className={`store-nav-link ${location.pathname.startsWith ('/couponlist') ? 'active' : ''}`}
              onClick={() => setSidebarOpen (false)}
            >
          ...
          <li className="store-nav-item">
            <Link
              to="/mystore"
              className={`store-nav-link ${location.pathname.startsWith ('/mystore') ? 'active' : ''}`}
              onClick={() => setSidebarOpen (false)}
            >
          ...
          <li className="store-nav-item">
            <Link
              to="/redeemedlist"
              className={`store-nav-link ${location.pathname.startsWith ('/redeemedlist') ? 'active' : ''}`}
              onClick={() => setSidebarOpen (false)}
            >
